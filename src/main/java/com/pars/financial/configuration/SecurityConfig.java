    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers("/api/v1/giftcard/customer/*").hasAnyRole("ADMIN", "API_USER", "SUPERADMIN", "COMPANY_USER", "STORE_USER")
                        ...
                        .requestMatchers("/api/v1/giftcard/block/*").hasAnyRole("ADMIN", "SUPERADMIN", "COMPANY_USER", "STORE_USER")
                        .requestMatchers("/api/v1/giftcard/unblock/*").hasAnyRole("ADMIN", "SUPERADMIN", "COMPANY_USER", "STORE_USER")
                        .requestMatchers("/api/v1/giftcard/activate/*").hasAnyRole("ADMIN", "SUPERADMIN", "COMPANY_USER", "STORE_USER")
                        .requestMatchers("/api/v1/giftcard/deactivate/*").hasAnyRole("ADMIN", "SUPERADMIN", "COMPANY_USER", "STORE_USER")
                        ...
                        .requestMatchers("/api/v1/discountcode/block/*").hasAnyRole("ADMIN", "SUPERADMIN", "COMPANY_USER", "STORE_USER")
                        .requestMatchers("/api/v1/discountcode/unblock/*").hasAnyRole("ADMIN", "SUPERADMIN", "COMPANY_USER", "STORE_USER")
                        .requestMatchers("/api/v1/discountcode/activate/*").hasAnyRole("ADMIN", "SUPERADMIN", "COMPANY_USER", "STORE_USER")
                        .requestMatchers("/api/v1/discountcode/deactivate/*").hasAnyRole("ADMIN", "SUPERADMIN", "COMPANY_USER", "STORE_USER")
